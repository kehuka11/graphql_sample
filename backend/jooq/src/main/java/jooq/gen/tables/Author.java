...
public class Author extends TableImpl<AuthorRecord> {
    ...
    /**
     * The column <code>library.author.authorId</code>.
     */
    public final TableField<AuthorRecord, String> AUTHORID = createField(DSL.name("authorId"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>library.author.firstName</code>.
     */
    public final TableField<AuthorRecord, String> FIRSTNAME = createField(DSL.name("firstName"), SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>library.author.lastName</code>.
     */
    public final TableField<AuthorRecord, String> LASTNAME = createField(DSL.name("lastName"), SQLDataType.VARCHAR(255), this, "");
