...
public class Book extends TableImpl<BookRecord> {
     ...
     */
    public final TableField<BookRecord, String> ID = createField(DSL.name("id"), SQLDataType.VARCHAR(255).nullable(false), this, "");
     ...
     */
    public final TableField<BookRecord, String> AUTHORID = createField(DSL.name("authorId"), SQLDataType.VARCHAR(255), this, "");
